(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
    [33861], {
        ...
        151699: (t, e, i) => {
            var s, n, o;
            n = [i(823127), i(834912)], void 0 === (o = "function" == typeof(s = function(t) {
        ...
        665216: (t, e, i) => {
            var s, n, o;
            n = [i(823127), i(834912)], s = function(t) {
                return t.ui.plugin = {
                    add: function(e, i, s) {
        ...
        834912: (t, e, i) => {
            var s, n, o;
            n = [i(823127)], void 0 === (o = "function" == typeof(s = function(t) {
        ...
        162066: (t, e, i) => {
            ...
            n = [i(823127), i(834912)], s = function(t) {
                ...
                return t.cleanData = (e = t.cleanData, function(i) {
                    ...
                    for (var i, n, o = s.call(arguments, 1), r = 0, a = o.length; r < a; r++)
                        for (i in o[r]) n = o[r][i], o[r].hasOwnProperty(i) && void 0 !== n && (t.isPlainObject(n) ? e[i] = t.isPlainObject(e[i]) ? t.widget.extend({}, e[i], n) : t.widget.extend({}, n) : e[i] = n);
                    return e
                    ...
                    t.fn[e] = function(o) {
                        ...
                        return r ? this.length || "instance" !== o ? this.each((function() {
                            ...
                            return "instance" === o ? (h = s, !1) : s ? t.isFunction(s[o]) && "_" !== o.charAt(0) ? (i = s[o].apply(s, a)) !== s && void 0 !== i ? (h = i && i.jquery ? h.pushStack(i.get()) : i, !1) : void 0 : t.error("no such method '" + o + "' for " + e + " widget instance") : t.error("cannot call methods on " + e + " prior to initialization; attempted to call method '" + o + "'")
                    ...
                    _classes: function(e) {
                        ...
                        function n(n, o) {
                            var r, a;
                            for (a = 0; a < n.length; a++) r = s.classesElementLookup[n[a]] || t(),
                                r = e.add ? t(t.unique(r.get().concat(e.element.get()))) : t(r.not(e.element).get()), s.classesElementLookup[n[a]] = r, i.push(n[a]), o && e.classes[n[a]] && i.push(e.classes[n[a]])
                        }
                        return e = t.extend({
        ...
        872994: (t, e, i) => {
            var s, n, o;
            n = [i(823127), i(834912), i(720294)], s = function(t) {
                var e;
                ...
                return t.extend(t.ui, {
                    ...
                    _inlineDatepicker: function(e, i) {
                        var s = t(e);
                        s.hasClass(this.markerClassName) || (s.addClass(this.markerClassName).append(i.dpDiv), t.data(e, "datepicker", i), this._setDate(i, this._getDefaultDate(i), !0), this._updateDatepicker(i), this._updateAlternate(i),
                        ...
                        for (n = 0; n < e.length; n++)
                            if (y) "'" !== e.charAt(n) || w("'") ? D() : y = !1;
                                ...
                                case "y":
                                    ...
                                    break;
                                case "@":
                                    g = (a = new Date(b("@"))).getFullYear(), m = a.getMonth() + 1, _ = a.getDate();
                                    break;
                                case "!":
                                    g = (a = new Date((b("!") - this._ticksTo1970) / 1e4)).getFullYear(), m = a.getMonth() + 1, _ = a.getDate();
                                    break;
                                case "'":
                                    w("'") ? D() : y = !0;
                                    break;
                    ...
                    _determineDate: function(e, i, s) {
                        ...
                        return (r = r && "Invalid Date" === r.toString() ? s : r) && (r.setHours(0), r.setMinutes(0), r.setSeconds(0), r.setMilliseconds(0)), this._daylightSavingAdjust(r)
                    },
                    ...
                    _generateHTML: function(t) {
                        var e, i, s, n, o, r, a, h, l, c, p, d, u, f, g, m, _, v, y, w, b, k, D, x, P, C, I, M, S, z, N, T, H, E, A, F, O, Y, W, R = new Date,
                            ...
                            tt = t.drawYear;
                        if (Q < 0 && (Q += 12, tt--), G)
                            for (e = this._daylightSavingAdjust(new Date(G.getFullYear(), G.getMonth() - U[0] * U[1] + 1, G.getDate())), e = Z && e < Z ? Z : e; this._daylightSavingAdjust(new Date(tt, Q, 1)) > e;) --Q < 0 && (Q = 11, tt--);
                        for (t.drawMonth = Q, t.drawYear = tt, i = this._get(t, "prevText"),
                            i = X ? this.formatDate(i, this._daylightSavingAdjust(new Date(tt, Q - $, 1)), this._getFormatConfig(t)) : i, s = this._canAdjustMonth(t, -1, tt, Q) ? "<a class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (j ? "e" : "w") + "'>" + i + "</span></a>" : B ? "" : "<a class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (j ? "e" : "w") + "'>" + i + "</span></a>", n = this._get(t, "nextText"), n = X ? this.formatDate(n, this._daylightSavingAdjust(new Date(tt, Q + $, 1)), this._getFormatConfig(t)) : n, o = this._canAdjustMonth(t, 1, tt, Q) ? "<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='" + n + "'><span class='ui-icon ui-icon-circle-triangle-" + (j ? "w" : "e") + "'>" + n + "</span></a>" : B ? "" : "<a class='ui-datepicker-next ui-corner-all ui-state-disabled' title='" + n + "'><span class='ui-icon ui-icon-circle-triangle-" + (j ? "w" : "e") + "'>" + n + "</span></a>", r = this._get(t, "currentText"), a = this._get(t, "gotoCurrent") && t.currentDay ? J : L, r = X ? this.formatDate(r, a, this._getFormatConfig(t)) : r, h = t.inline ? "" : "<button type='button' class='ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all' data-handler='hide' data-event='click'>" + this._get(t, "closeText") + "</button>", l = K ? "<div class='ui-datepicker-buttonpane ui-widget-content'>" + (j ? h : "") + (this._isInRange(t, a) ? "<button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'>" + r + "</button>" : "") + (j ? "" : h) + "</div>" : "", c = parseInt(this._get(t, "firstDay"), 10), c = isNaN(c) ? 0 : c, p = this._get(t, "showWeek"), d = this._get(t, "dayNames"), u = this._get(t, "dayNamesMin"), f = this._get(t, "monthNames"), g = this._get(t, "monthNamesShort"), m = this._get(t, "beforeShowDay"), _ = this._get(t, "showOtherMonths"), v = this._get(t, "selectOtherMonths"), y = this._getDefaultDate(t), w = "", k = 0; k < U[0]; k++) {
                            for (D = "", this.maxRows = 4, x = 0; x < U[1]; x++) {
                                if (P = this._daylightSavingAdjust(new Date(tt, Q, t.selectedDay)), C = " ui-corner-all", I = "", q) {
                                    if (I += "<div class='ui-datepicker-group", U[1] > 1) switch (x) {
                                        case 0:
                                            I += " ui-datepicker-group-first", C = " ui-corner-" + (j ? "right" : "left");
                                            break;
                                        case U[1] - 1:
                                            I += " ui-datepicker-group-last", C = " ui-corner-" + (j ? "left" : "right");
                                            break;
                                        default:
                                ...
                                for (I += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + C + "'>" + (/all|left/.test(C) && 0 === k ? j ? o : s : "") + (/all|right/.test(C) && 0 === k ? j ? s : o : "") + this._generateMonthYearHeader(t, Q, tt, Z, G, k > 0 || x > 0, f, g) + "</div><table class='ui-datepicker-calendar'><thead><tr>", M = p ? "<th class='ui-datepicker-week-col'>" + this._get(t, "weekHeader") + "</th>" : "", b = 0; b < 7; b++) M += "<th scope='col'" + ((b + c + 6) % 7 >= 5 ? " class='ui-datepicker-week-end'" : "") + "><span title='" + d[S = (b + c) % 7] + "'>" + u[S] + "</span></th>";
                                for (I += M + "</tr></thead><tbody>", z = this._getDaysInMonth(tt, Q), tt === t.selectedYear && Q === t.selectedMonth && (t.selectedDay = Math.min(t.selectedDay, z)), N = (this._getFirstDayOfMonth(tt, Q) - c + 7) % 7, T = Math.ceil((N + z) / 7), H = q && this.maxRows > T ? this.maxRows : T, this.maxRows = H,
                                    E = this._daylightSavingAdjust(new Date(tt, Q, 1 - N)), A = 0; A < H; A++) {
                                    for (I += "<tr>", F = p ? "<td class='ui-datepicker-week-col'>" + this._get(t, "calculateWeek")(E) + "</td>" : "", b = 0; b < 7; b++) O = m ? m.apply(t.input ? t.input[0] : null, [E]) : [!0, ""], W = (Y = E.getMonth() !== Q) && !v || !O[0] || Z && E < Z || G && E > G, F += "<td class='" + ((b + c + 6) % 7 >= 5 ? " ui-datepicker-week-end" : "") + (Y ? " ui-datepicker-other-month" : "") + (E.getTime() === P.getTime() && Q === t.selectedMonth && t._keyEvent || y.getTime() === E.getTime() && y.getTime() === P.getTime() ? " " + this._dayOverClass : "") + (W ? " " + this._unselectableClass + " ui-state-disabled" : "") + (Y && !_ ? "" : " " + O[1] + (E.getTime() === J.getTime() ? " " + this._currentClass : "") + (E.getTime() === L.getTime() ? " ui-datepicker-today" : "")) + "'" + (Y && !_ || !O[2] ? "" : " title='" + O[2].replace(/'/g, "&#39;") + "'") + (W ? "" : " data-handler='selectDay' data-event='click' data-month='" + E.getMonth() + "' data-year='" + E.getFullYear() + "'") + ">" + (Y && !_ ? "&#xa0;" : W ? "<span class='ui-state-default'>" + E.getDate() + "</span>" : "<a class='ui-state-default" + (E.getTime() === L.getTime() ? " ui-state-highlight" : "") + (E.getTime() === J.getTime() ? " ui-state-active" : "") + (Y ? " ui-priority-secondary" : "") + "' href='#'>" + E.getDate() + "</a>") + "</td>", E.setDate(E.getDate() + 1), E = this._daylightSavingAdjust(E);
                                    I += F + "</tr>"
                                }++Q > 11 && (Q = 0, tt++), D += I += "</tbody></table>" + (q ? "</div>" + (U[0] > 0 && x === U[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : "") : "")
                            }
                            w += D
                        }
                    ...
                    _generateMonthYearHeader: function(t, e, i, s, n, o, r, a) {
                        ...
                        if (o || !m) w += "<span class='ui-datepicker-month'>" + r[e] + "</span>";
                            ...
                            for (h = s && s.getFullYear() === i, l = n && n.getFullYear() === i, w += "<select class='ui-datepicker-month' data-handler='selectMonth' data-event='change'>", c = 0; c < 12; c++)(!h || c >= s.getMonth()) && (!l || c <= n.getMonth()) && (w += "<option value='" + c + "'" + (c === e ? " selected='selected'" : "") + ">" + a[c] + "</option>");
                            w += "</select>"
                        }
                        if (v || (y += w + (!o && m && _ ? "" : "&#xa0;")), !t.yearshtml)
                            if (t.yearshtml = "", o || !_) y += "<span class='ui-datepicker-year'>" + i + "</span>";
                            else {
                                for (p = this._get(t, "yearRange").split(":"), d = (new Date).getFullYear(), u = function(t) {
                                        var e = t.match(/c[+\-].*/) ? i + parseInt(t.substring(1), 10) : t.match(/[+\-].*/) ? d + parseInt(t, 10) : parseInt(t, 10);
                                        return isNaN(e) ? d : e
                                    }, f = u(p[0]), g = Math.max(f, u(p[1] || "")), f = s ? Math.max(f, s.getFullYear()) : f, g = n ? Math.min(g, n.getFullYear()) : g, t.yearshtml += "<select class='ui-datepicker-year' data-handler='selectYear' data-event='change'>"; f <= g; f++) t.yearshtml += "<option value='" + f + "'" + (f === i ? " selected='selected'" : "") + ">" + f + "</option>";
                                t.yearshtml += "</select>", y += t.yearshtml, t.yearshtml = null
                            }
                        return y += this._get(t, "yearSuffix"), v && (y += (!o && m && _ ? "" : "&#xa0;") + w), y += "</div>"
                    },
                    _adjustInstDate: function(t, e, i) {
                        ...
                        t.selectedDay = r.getDate(), t.drawMonth = t.selectedMonth = r.getMonth(),
                            t.drawYear = t.selectedYear = r.getFullYear(), "M" !== i && "Y" !== i || this._notifyChange(t)
                    },
        ...
        329224: (t, e, i) => {
            var s, n, o;
            n = [i(823127), i(452282), i(151699), i(665216), i(608002), i(178734), i(815925), i(834912), i(162066)], void 0 === (o = "function" == typeof(s = function(t) {
        ...
        452282: (t, e, i) => {
            var s, n, o;
            n = [i(823127), i(558264), i(834912), i(162066)], void 0 === (o = "function" == typeof(s = function(t) {
                var e = !1;
                return t(document).on("mouseup", (function() {
                    ...
                    _mouseUp: function(i) {
                        this.document.off("mousemove." + this.widgetName, this._mouseMoveDelegate).off("mouseup." + this.widgetName, this._mouseUpDelegate),
                            this._mouseStarted && (this._mouseStarted = !1, i.target === this._mouseDownEvent.target && t.data(i.target, this.widgetName + ".preventClickEvent", !0), this._mouseStop(i)), this._mouseDelayTimer && (clearTimeout(this._mouseDelayTimer), delete this._mouseDelayTimer), this.ignoreMissingWhich = !1, e = !1, i.preventDefault()
                    },
        ...
        398135: (t, e, i) => {
            var s, n, o;
            n = [i(823127), i(452282), i(739525), i(665216), i(834912), i(162066)], s = function(t) {
                return t.widget("ui.resizable", t.ui.mouse, {
                    ...
                    _updateCache: function(t) {
                        this.offset = this.helper.offset(), this._isNumber(t.left) && (this.position.left = t.left),
                            this._isNumber(t.top) && (this.position.top = t.top), this._isNumber(t.height) && (this.size.height = t.height), this._isNumber(t.width) && (this.size.width = t.width)
                    },
        ...
        768363: (t, e, i) => {
            var s, n, o;
            n = [i(823127), i(452282), i(151699), i(558264), i(815925), i(834912), i(162066)], s = function(t) {
                    ...
                    _getItemsAsjQuery: function(e) {
                        ...
                        if (h && e)
                            for (i = h.length - 1; i >= 0; i--)
                                for (s = (n = t(h[i], this.document[0])).length - 1; s >= 0; s--)(o = t.data(n[s], this.widgetFullName)) && o !== this && !o.options.disabled && a.push([t.isFunction(o.options.items) ? o.options.items.call(o.element) : t(o.options.items, o.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"), o]);
                    ...
                    _refreshItems: function(e) {
                        ...
                        if (d && this.ready)
                            for (i = d.length - 1; i >= 0; i--)
                                for (s = (n = t(d[i], this.document[0])).length - 1; s >= 0; s--)(o = t.data(n[s], this.widgetFullName)) && o !== this && !o.options.disabled && (p.push([t.isFunction(o.options.items) ? o.options.items.call(o.element[0], e, {
                                    item: this.currentItem
                                }) : t(o.options.items, o.element), o]), this.containers.push(o));
                        for (i = p.length - 1; i >= 0; i--)
                            for (r = p[i][1], s = 0, l = (a = p[i][0]).length; s < l; s++)(h = t(a[s])).data(this.widgetName + "-item", r), c.push({
                                item: h,
                                instance: r,
                                width: 0,
                                height: 0,
                        ...
                        s.placeholder && s.placeholder.constructor !== String || (i = s.placeholder, s.placeholder = {
                            element: function() {
                                ...
                                return e._addClass(n, "ui-sortable-placeholder", i || e.currentItem[0].className)._removeClass(n, "ui-sortable-helper"),
                                    "tbody" === s ? e._createTrPlaceholder(e.currentItem.find("tr").eq(0), t("<tr>", e.document[0]).appendTo(n)) : "tr" === s ? e._createTrPlaceholder(e.currentItem, n) : "img" === s && n.attr("src", e.currentItem.attr("src")), i || n.css("visibility", "hidden"), n
                            },
                            update: function(t, n) {
        ...
        548428: (t, e, i) => {
            "use strict";
            i.r(e);
            i(893381), i(329224), i(768363), i(872994), i(398135), i(394822), i(115242)
        },
        115242: (t, e, i) => {
            var s = i(823127);
            s.ui.sortable.prototype._addClass = function(t, e) {
                return "string" == typeof t || null === t ? this.element.addClass(t) : t.addClass(e), this
            }, s.ui.sortable.prototype._removeClass = function(t, e) {
