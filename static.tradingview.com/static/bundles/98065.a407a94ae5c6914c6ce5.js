(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
    [98065], {
        ...
        733647: (a, t, c) => {
            ...
            function g(a) {
                return a.replace(new RegExp(r, "gi"), l.t(null, {
                    replace: {
                        username: "$1"
                    }
            ...
            function i(a) {
                const t = function(a) {
                    const t = new RegExp(r, "ig"),
                        ...
                        g = t.exec(a),
                        i = s.exec(a);
                    return !g || !i || i.index < g.index ? null : {
                        converted: '<div class="ch-item-quote">' + l.t(null, {
                            replace: {
                                username: g[1]
                            }
                        }, c(775349)) + ":<br/>" + h(a.substring(t.lastIndex, i.index)) + "</div>",
                        end: s.lastIndex,
                        start: g.index
                    }
                }(a);
        ...
        356361: (a, t, c) => {
            ...
            function e(a, t) {
                let c = "";
                return l.default.parse(a, (a => (c = l.default.base + ("svg" === t ? `svg/${a}.svg` : `72x72/${a}.png`), !1))), c
            }
            l.default.base = "https://cdnjs.cloudflare.com/ajax/libs/twemoji/13.0.1/"
        },
        698065: (a, t, c) => {
            "use strict";
            c.r(t), c.d(t, {
            ...
            function m(a) {
                ...
                if (t)
                    for (var r = 0; r < t.length; r++) {
                        var s;
                        a.text = a.text.replace(t[r], "<" + a.count++ + ">"), -1 !== t[r].indexOf("amazonaws") && -1 === t[r].indexOf("_thumb") && ((s = t[r].split("."))[s.length - 2] += "_thumb", s = encodeURI(s.join(".")));
                        var g = (0, e.htmlEscape)(l.t(null, void 0, c(511938))),
                            h = encodeURI(t[r]);
                        a.values.push(`<div class="ch-item-snapshot-link"><i class="icon icon-snapshot-small" title="${g}"></i><a href="${h}" target="_blank">${g}</a></div><div class="ch-item-snapshot-preview"><a target="_blank" href="${h}"><img src="${s||h}" loading="lazy" alt="" class="snapshot-preview"/>\t</a></div>`)
                    }
                return a
            }
            ...
            const A = function() {
                    ...
                    var t = "(?:https:\\/\\/|http:\\/\\/)(?:(?:[\\w\\d\\.\\_\\-]+\\.)?tradingview\\.com|webcharts\\d?|localhost\\:6285)",
                        ...
                        g = s.urlsRegExp.publishedScript,
                        h = s.urlsRegExp.amazonawsLinks;
                    return {
                        snapshots: new RegExp(t + l + "|" + h, "g"),
                        comments: new RegExp(t + a(e + c, r + c, g + c), "g"),
                        deprecatedCharts: new RegExp(t + a(e, r, g), "g")
                    }
                }(),
                H = [m, w, x, M, u, z, C],
                B = [m, w, function(a) {
                    ...
                    if (t)
                        for (var r = 0; r < t.length; r++) {
                            a.text = a.text.replace(t[r], "<" + a.count++ + ">");
                            var s = (0, g.parsePublishedChartUrl)(t[r]),
                                h = (0, e.htmlEscape)((0, g.createPublishedChartUrl)(s.image_url, s.symbol, s.title)),
                                i = (0, g.createPublishedChartImageUrl)(s.image_url),
                                f = encodeURI(s.image_url),
                                v = s.symbol ? (0, e.htmlEscape)(s.symbol) : void 0,
                                o = s.title ? (0, e.htmlEscape)(s.title) : void 0;
                            a.values.push(`<div class="ch-item-chart-link"><i class="icon icon-snapshot-small" title="${l.t(null,void 0,c(442537))}"></i><a href="${h}" target="_blank" data-id="${f}" ` + (v ? `data-symbol="${v}"` : "") + " " + (o ? `data-title="${o}"` : "") + `>${(0,e.htmlEscape)(l.t(null,void 0,c(442537)))}</a></div><div class="ch-item-chart-preview"><a ` + ` href="${h}" target="_blank"` + ` data-id="${f}" ` + (v ? ` data-symbol="${v}"` : "") + " " + (o ? ` data-title="${o}"` : "") + ">" + `<img src="${i}" loading="lazy" alt="" class="idea-preview"/></a></div>`)
                        }
                    return a
                }, x, M, u, z, C];
            ...
            function L(a, t) {
                ...
                return (c = y(c)).text = (0, h.parseQuotes)(c.text), c.text = (0, i.parseBBCode)(c.text), V(c, B.concat(t))
            }
        },
        447245: a => {
