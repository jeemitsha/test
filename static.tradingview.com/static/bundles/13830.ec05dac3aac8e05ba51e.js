(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
    [13830], {
        ...
        13830: (t, e, o) => {
            ...
            function c(t) {
                ...
                return s.createElement("div", {
                    className: i(r["toast-wrapper"], "compact" === e && r.compact)
                }, o)
            }
            const d = new class {
                constructor() {
                    ...
                    }, this._toastsLayer = new n.ToastsLayer(this._getSuggestedLayout(), void 0, void 0, this._getLocation()), this._mediaQuery.addListener(this._handleMediaQueryChange), null === (t = window.loginStateChange) || void 0 === t || t.subscribe(this, this._handleLoginStateChange)
                }
                destroy() {
                    var t;
                ...
                showCustomToast(t) {
                    ...
                    return this._toastsLayer.showToast({
                        render: (i = e, t => s.createElement(c, {
        ...
        799217: (t, e, o) => {
            ...
            class l {
                constructor(t) {
                    this._animationStage = g.ToastAnimationStage.Add, this._keys = new Map, this._element = null, this.render = t => this._render(t), this.remove = t => {
                    ...
                    this._staticData = Object.freeze({
                        ...
                        this._currentToastsLayer = s || o, this._render = n
                }
                getStaticData() {
            ...
            class v {
                ...
                showToast(t) {
                    ...
                    return u.setKey(this, m), "compact" === this._suggestedLayout && o === g.ToastPriority.Low ? Promise.all(this._toasts[g.ToastPriority.Low].map((t => this.removeToast(t)))).then((() => {
                        this._add(u, i), this._render()
                    })) : (this._add(u, i), this._render()), u
                }
                showExistingToast(t) {
                ...
                update(t) {
                    ...
                    let n = !1,
                        a = !1;
                    void 0 !== e && e !== this._suggestedLayout && (this._setSuggestedLayout(e), n = !0), void 0 !== o && (this._setLocation(o), a = !0), void 0 !== s && (this._setContainer(s), a = !0),
                        void 0 !== i && (this._updateRootContainer(i), a = !0), n ? "compact" === this._suggestedLayout && this._toasts[g.ToastPriority.Low].slice(0, -1).forEach((t => this.removeToast(t))) : a && this._render()
                }
                getToasts() {
                    return this._toasts
                }
            ...
            function T(t, e) {
                ...
                void 0 !== a && (t.style.position = a), void 0 !== r && (t.style.zIndex = String(r)), void 0 !== o && (t.style.top = o), void 0 !== s && (t.style.right = s), void 0 !== i && (t.style.bottom = i), void 0 !== n && (t.style.left = n)
            }
            ...
            function C(t) {
                const {
                    ...
                    location: c,
                    forceRender: d
                } = t, u = (0, i.useRef)(null), l = e.getStaticData().swipeToCloseDirection, [p, v] = m(.2, .7), L = e.getAnimationStage(), T = L !== g.ToastAnimationStage.None, C = L === g.ToastAnimationStage.Add, [w, S] = function(t, e, o, i) {
                    var n, a;
                    const r = e.indexOf(t),
                        h = f(t, r, o);
                    let c = 0,
                    ...
                    for (const t of e) {
                        const u = e.indexOf(t),
                            l = f(t, u, o),
                            m = (null === (n = t.getElement()) || void 0 === n ? void 0 : n.offsetHeight) || 0,
                            y = (null === (a = t.getElement()) || void 0 === a ? void 0 : a.offsetWidth) || 0,
                            p = (0, _.isRtl)() ? y : -y,
                            v = t.getAnimationStage() !== g.ToastAnimationStage.None && i === s.Unset,
                            L = i === t.getStaticData().swipeToCloseDirection;
                        let T = 0;
                        v && l === h ? T = 1 : !v && r < u && (T = -1), c += T * m, d = L ? p : 0
                    }
                    return [c, d]
                }(e, o, n, p), M = a(y["toast-positioning-wrapper"], T && y.hidden, C && y.added, "compact" === r && y.compact, c && y[`location-${c}`]);
                return (0,
                    i.useEffect)((() => {
                    if (e.getCurrentLayer() !== n || e.getAnimationStage() !== g.ToastAnimationStage.Add || null === u.current) return;
                    const t = e.getElement();
                    null === t || t !== u.current ? (e.setElement(u.current), d()) : (e.setAnimationStage(g.ToastAnimationStage.None), d())
                })), (0, i.useEffect)((() => {
                    p === l && p !== s.Unset && e.remove(g.CloseTrigger.Swipe)
                }), [p, e]), i.createElement(h.Portal, {
                    layerOptions: {
                        position: "absolute"
                    },
                    left: "0",
            ...
            function w(t) {
                ...
                return i.createElement(c.SlotContext.Provider, {
                    value: n
                }, e.map(((t, n) => i.createElement(C, {
                    key: f(t, n, a),
                    toast: t,
                    toasts: e,
                    layer: a,
